# ===========================================================================
#This code has been edited from SunFounder Pi_Car-V
#Color numbers were gotten from a program that allows you to determine the numbers to pin point the colors
# ===========================================================================
...
import front_wheels, motor, Servo #modules needed to opperate with the individual servos and motors
...
# ===========================================================================
#Code used to turn individual functions on and off
# ===========================================================================

show_image_enable   = True #show camera view
draw_circle_enable  = True #create circle around input to be able to tell what it is tracking
scan_enable         = True
rear_wheels_enable  = True #allow wheels to opperate (car move forward)
front_wheels_enable = True #allow front wheels to work so that it turns
pan_tilt_enable     = True #allow pan-and-tilt
...
# ===========================================================================
# Filter setting, how it knows to look for red
# ===========================================================================
...
bw = motor.Motor()
fw = front_wheels.Front_Wheels(0) #Number represents where the servos can be found
pan_servo = Servo.Servo(14) #Number represents where the servos can be found
tilt_servo = Servo.Servo(15) #Number represents where the servos can be found

fw.offset = 0
pan_servo.offset = 10
tilt_servo.offset = 0

bw.setSpeed = 0 #speed can be found in the motor file
fw.turn(90) #turn can be found in the front_wheels file
pan_servo.write(90) #write can be found in the Servo file
tilt_servo.write(90)#write can be found in the Servo file

motor_speed = 60 #speed of the car
